...
while ($row = $r->fetchArray(SQLITE3_ASSOC)) {
    ...
    $stmt2->bindValue(':cid', $row['id'], SQLITE3_INTEGER);
    $stmt2->bindValue(':year', $report_year, SQLITE3_INTEGER);
